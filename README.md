# Joplin Plugin
A plugin that allows with a shortcut to start a note in a default folder (regardless of what
folder you're currently on.) While I'm working, I often don't know what folder I really want 
the note to end up in, so I created a "misc" folder ('inbox' is another good name) and when I 
